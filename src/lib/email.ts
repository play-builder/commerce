...
const sender = {
  email: "myadmin@testadmin.com",
  name: "Next Ecommerce Site Verification",
};
...
const sendVerificationLinkEmail = async (profile: profile, linkUrl: string) => {
...
export const sendEmail = (options: EmailOptions) => {
  ...
  console.log(profile, subject, linkUrl);
  switch (subject) {
    case "verification":
      return sendVerificationLinkEmail(profile, linkUrl!);
